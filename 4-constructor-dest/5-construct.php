<?php
    ...
    class Trainer extends Person {
        private $job;
        private $time;
        function __construct($fname, $lname, $time="Full-Time"){
    ...
    echo $tech2->getData();  // Ahmad Mario As Student
    echo "<br>";
    $tech2->setAs("Designer");
    $tech2->setJob("Adobe");
    echo $tech2->getAllData();  // Ahmad Mario As Designer - Job: Adobe - Time: Part
