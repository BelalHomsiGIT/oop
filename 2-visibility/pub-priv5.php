<?php
    ...
    */
    ...
    //we use a public methods to reach the unvisible properties.
    echo $object->getName();  // Belal
    echo "<br>";
    $object->setName("Tata");
    echo $object->getName();  // Tata
    echo "<br>";
    $object->setLast("Tataaaa");
    echo $object->getAll(); // Hello Tata Tataaaa Change OOP
    echo "<br>";
