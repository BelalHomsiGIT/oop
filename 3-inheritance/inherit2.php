<?php
    ...
    echo "------------------------------ <br>";
    $object1 = new Test1;
    // we cann't reach the private member: name and last properties, and hello() method (directly).
    /*
    echo $object1 -> name; // Fatal error: Cannot access private property Test1::$name
    echo $object1 -> last; // Fatal error: Cannot access protected property Test1::$last
    echo $object1 -> hello(); // Fatal error: Uncaught Error: Call to private method Test1::hello()
    echo $object1 -> bye(); // Fatal error: Uncaught Error: Call to protected method Test1::bye()
    */
